...
from select_tool_v2 import select_1, load_js1, load_js2, load_js3 , push_db # 載入資料庫函式工具
...
def handle_message(event):
    ...
    # 推薦商品 
        ...
        # 選擇膚質 功能
            ...
            flex_msg3 = FlexSendMessage(alt_text="flex_msg", contents=load_js3(product_data, skin_os, age_os))
        ...
        #     with open('contents.json', mode='r', encoding='utf-8') as fi:
        #         js = json.load(fi)
        #         all_js = []
        #         for i in range(3):
        #             all_js.append(js)
        #         line_bot_api.reply_message(event.reply_token, [FlexSendMessage(alt_text="flex_msg", contents=content) for content in all_js])
